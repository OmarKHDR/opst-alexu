                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Play size={24} className="text-[#003366] ml-1" />
                    </div>
                  </div>
                  
                  {/* Resource Type Badge */}
                  <div className="absolute top-4 left-4">
                    <div className="px-3 py-1 bg-[#FDB813] text-[#003366] rounded-full text-xs font-inter font-semibold shadow-lg">
                      {resource.type}
                    </div>
                  </div>
                  ...
                  <div className="absolute top-4 right-4">
                    <div className="px-3 py-1 bg-black/70 text-white rounded-full text-xs font-inter font-medium flex items-center gap-1">
                      <Clock size={12} />
                      {resource.duration}
                    </div>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {resource.tags.map((tag, index) => (
                      <span
                        key={index}
                        className={`px-3 py-1 rounded-full text-sm font-inter shadow-sm transition-all duration-200 ${
                      ...
                      >
                        {tag === 'Video Guide' && <BookOpen size={12} className="inline mr-1" />}
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="mb-6">
                    <h4 className="font-inter text-sm font-medium text-[#1A1A1A] mb-2">DESCRIPTION</h4>
                    <p className="font-inter text-[#555555] text-sm leading-relaxed">
                      {resource.description}
                    </p>
                  </div>

                  <Button className="bg-[#FDB813] hover:bg-[#FDB813]/90 text-[#003366] font-inter font-medium px-6 py-3 w-full shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1 focus:ring-2 focus:ring-[#FDB813] focus:ring-offset-2 group-hover:scale-[1.02] flex items-center justify-center gap-2">
                    <Play size={16} />
                    WATCH NOW
                  </Button>
                </div>
