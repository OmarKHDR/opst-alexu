      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-4xl mx-auto">
          ...
          {resources.map((resource) => {
            const link = resource.link.startsWith('http://') || resource.link.startsWith('https://') ? resource.link : `https://${resource.link}`
            return (
              <div
                key={resource.id}
                ...
                <div className="relative z-10">
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <a
                      ...
                      className="bg-[#FDB813] hover:bg-[#FDB813]/90 text-[#003366] font-inter font-medium px-4 sm:px-6 py-2 sm:py-3 w-full text-xs sm:text-sm shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1 focus:ring-2 focus:ring-[#FDB813] focus:ring-offset-2 group-hover:scale-[1.02] flex items-center justify-center gap-1.5 sm:gap-2 rounded-md"
                    >
                      <Play size={14} className="sm:w-4 sm:h-4" />
                      {resource.callToAction || 'WATCH NOW'}
                    </a>
                  </div>
                </div>
              </div>
