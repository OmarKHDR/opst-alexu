            ...
            {displayedOpportunities.map((opportunity) => (
              ...
              >
                ...
                <div className="relative z-10 flex gap-6 items-start">
                  {/* Company Logo */}
                  <div className="w-16 h-16 bg-gradient-to-br from-[#003366] to-[#3399FF] rounded-2xl flex-shrink-0 shadow-lg group-hover:shadow-xl transition-shadow duration-300 flex items-center justify-center">
                    <Building2 size={24} className="text-white" />
                  </div>

                  {/* Content */}
                  <div className="flex-1">
                    <h3 className="font-merriweather text-xl font-bold text-[#1A1A1A] mb-2 group-hover:text-[#003366] transition-colors duration-200">
                      {opportunity.title}
                    </h3>
                    <p className="font-inter text-[#555555] mb-4 font-medium flex items-center gap-2">
                      <Building2 size={16} />
                      {opportunity.company}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-4 mb-4 text-sm">
                      <div className="flex items-center gap-2 text-[#555555] bg-white px-3 py-1 rounded-full shadow-sm">
                        <MapPin size={14} />
